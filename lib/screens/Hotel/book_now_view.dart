...
bool isLoading = false ;
  ...
  Future<void> bookHotel() async {
    ...
    var request =
    http.Request('POST', Uri.parse('${flightUrl}oms/v1/hotel/book'));
    ...
    if (response.statusCode == 200) {
      ...
      final jsonResponse =
      HotelBookingResponse.fromJson(json.decode(finalResult));
      ...
      Fluttertoast.showToast(msg: 'Booking Expired Please select room again');
